Rails.application.configure do
  ...
  config.assets.compile = true # To compile custom css
  ...
  config.middleware.use DigestAuthUnless, "daimon", ENV["DIGEST_AUTH_SECRET_KEY"], (-> (env) { env["PATH_INFO"] =~ %r{\A/api/} || env["PATH_INFO"] =~ %r{\A/assets/} }) do |username|
